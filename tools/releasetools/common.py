...
class BlockDifference(object):
  ...
  def WriteScript(self, script, output_zip, progress=None,
    ...
    if not self.src:
      ...
      script.Print(" ")
      script.Print("Flashing xdroidOSS %s partition..." % (self.partition,))
    else:
      script.Print(" ")
      script.Print("Flashing xdroidOSS %s partition after verification." % (self.partition,))
  ...
  def WritePostInstallVerifyScript(self, script):
    ...
    if self.tgt.extended:
      ...
      script.Print(" ")
      script.Print('Verified xdroidOSS %s partition.' % (partition,))
      if partition == "system":
